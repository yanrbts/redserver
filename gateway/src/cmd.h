...
#define SOCKET_PATH     "/tmp/rqreflex.sock"
...
/**
 * @brief Specialized response function for informational messages (gray color).
 * Uses gray coloring to differentiate informational output from errors and successes.
 * @param r      Pointer to the command response context.
 * @param fmt    Printf-style format string for the informational message.
 * @param ...    Variable arguments.
 */
